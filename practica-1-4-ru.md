...
## 2. ПЕРЕЧЕНЬ КЛЮЧЕВЫХ УЧАСТНИКОВ И СТЕЙКХОЛДЕРОВ
...
### 3.1. Способ 1: Анализ проблем информационных потоков (*Flujo de analisis de información*)
...
### 3.2. Способ 2: Диаграмма Ишикавы / Fishbone (Análisis Causa-Efecto)
...
## 4. ЛОГИКО-СТРУКТУРНАЯ МАТРИЦА ПРОЕКТА
